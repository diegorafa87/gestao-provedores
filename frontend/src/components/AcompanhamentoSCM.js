...
export default function AcompanhamentoSCM({ cnpj, razaoSocial }) {
  ...
  // Exibir aviso se não houver razaoSocial, mas mostrar meses mesmo assim
  const aviso = !razaoSocial ? (
    <div style={{
      background: '#fff3cd',
      color: '#856404',
      ...
      Atenção: selecione um cliente para salvar os dados de SCM corretamente.
    </div>
  ) : null;
